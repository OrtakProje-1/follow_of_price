...
class TicketView extends StatelessWidget {
  ...
  const TicketView({
    ...
    this.topBorderRadius = 4,
    this.bottomBorderRadius=4,
      ...
      child: Container(
        ...
        child: ClipPath(
          clipper: TicketViewClipper(drawTriangle, drawArc, triangleAxis,
              triangleSize, trianglePos, drawDivider, topBorderRadius),
          child: child,
        ),
      ),
    );
...
class TicketViewPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (drawShadow) canvas.drawShadow(path, shadowColor, elevation, true);
